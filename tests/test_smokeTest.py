...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("wrong username")
  ...
  def test_directoryPageGridandList(self):
  ...
  def test_homepageLogoTitleandTab(self):
  ...
  def test_homepageNavigationandJoinusbutton(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1936, 1096)
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Business Leadership")
